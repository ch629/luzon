...
interface ASTNodeVisitor<T> {
    ...
    fun visit(node: ASTNode.Expression.Binary.Mod): T = throw NotImplementedError("ASTNode.Expression.Binary.Mod visitor not implemented.")
...
fun <T> ASTNode.accept(visitor: ASTNodeVisitor<T>) = when (this) {
    ...
    is ASTNode.Expression.Binary.Mod -> visitor.visit(this)
