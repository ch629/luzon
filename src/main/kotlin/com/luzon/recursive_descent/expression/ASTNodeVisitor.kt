...
interface ASTNodeVisitor<T> {
    ...
    fun visit(node: ASTNode.Expression.Binary.Subtract): T = throw NotImplementedError("ASTNode.Expression.Binary.Sub visitor not implemented.")
    fun visit(node: ASTNode.Expression.Binary.Multiply): T = throw NotImplementedError("ASTNode.Expression.Binary.Mult visitor not implemented.")
    fun visit(node: ASTNode.Expression.Binary.Divide): T = throw NotImplementedError("ASTNode.Expression.Binary.Div visitor not implemented.")
    fun visit(node: ASTNode.Expression.Binary.Modulus): T = throw NotImplementedError("ASTNode.Expression.Binary.Mod visitor not implemented.")
    ...
    fun visit(node: ASTNode.Expression.Unary.Minus): T = throw NotImplementedError("ASTNode.Expression.Unary.Sub visitor not implemented.")
...
fun <T> ASTNode.accept(visitor: ASTNodeVisitor<T>) = when (this) {
    ...
    is ASTNode.Expression.Binary.Subtract -> visitor.visit(this)
    is ASTNode.Expression.Binary.Multiply -> visitor.visit(this)
    is ASTNode.Expression.Binary.Divide -> visitor.visit(this)
    is ASTNode.Expression.Binary.Modulus -> visitor.visit(this)
    ...
    is ASTNode.Expression.Unary.Minus -> visitor.visit(this)
