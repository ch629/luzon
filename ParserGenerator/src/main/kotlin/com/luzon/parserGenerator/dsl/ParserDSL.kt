...
import com.luzon.parserGenerator.generator.ClassParameter
import com.luzon.parserGenerator.generator.SealedClass
...
sealed class FSMAlphabet {
    ...
    fun paramTypeName() =
            (if (this is AlphabetTokenEnum) tokenEnum.id()!! else name()).capitalize()

    fun isLiteral() = this is AlphabetTokenEnum && tokenEnum is Literal
}
